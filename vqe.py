...
class VQE(QuantumAlgorithm):
    ...
    def __init__(self, operator, var_form, optimizer, errors1Qubit, errors2qubit, operator_mode='matrix',
        ...
        self.errors1Qubit = errors1Qubit
        self.errors2Qubit = errors2qubit
        self.noiseModel = self._get_noise_model()
    ...
    def _solve(self):
        ...
        if self._quantum_instance.is_statevector:
            ret = self._quantum_instance.execute(qc, noise_model = self.noiseModel)
    ...
    def _get_noise_model(self):
        ...
        for i in range(self._operator.num_qubits):
    
            for error in self.errors1Qubit:
            ...
            for error in self.errors2Qubit:
                for j in range(self._operator.num_qubits):
    ...
    def _eval_aux_ops(self, threshold=1e-12):
        ...
        if len(circuits) > 0:
            ...
            if self._use_simulator_operator_mode:
                ...
                extra_args = {'noise_model':self.noiseModel}
